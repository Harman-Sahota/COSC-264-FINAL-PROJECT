...
if(isset($_GET['firstname1'])&&$_GET['lastname1']){
    $getsearch1 = $_GET['firstname1'];
    $getsearch2 = $_GET['lastname1'];
$getsearch2 = filter_var($getsearch2,FILTER_SANITIZE_STRING);
$getsearch1 = filter_var($getsearch2,FILTER_SANITIZE_STRING);

}
//no filter

//filter by author for info recieved
if(isset($getsearch2) && isset($getsearch1)){
    ...
    ON bookcategoriesbooks.CategoryID = bookcategories.CategoryID WHERE (nameF LIKE '%$getsearch1%') OR (nameL LIKE '%$getsearch2%');";
      ...
      while ($row = mysqli_fetch_assoc($results))
    {
       ...
       echo "<a href='product.php?title=$title' style=' text-decoration: none;color: #222222;'><b>$title</b></a>";
        echo "<br/>";
     echo "by <a href='index.php?firstname1=$fname' style=' text-decoration: none;color: blue;font-size:12px'><b><i>$fname $lname</b></i> </a>";
      echo "<br/>";
